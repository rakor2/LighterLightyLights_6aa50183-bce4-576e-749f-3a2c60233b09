...
ModName = {
    'This mod is not about lighting anymore',
    'This mod is not about lighting anymore',
    'This mod is not about lighting anymore',
    'This mod is not about lighting anymore',
    'Photy Photos',
...
MOTD = {
    ...
    [[There's a spider in my yard]],
    [["When will you bondage me"]],
    [[ARS :chart_with_upwards_trend:]],
    'SHE AGREED TO BONDAGE',
    [[:xd:]],
    'A finch',
    'Patience is our key <3',
    'Te amo mi luna',
    'Mi amora',
    'ibai presenta fighters PagMan',
    'Juan lets gooooo PagMan',
...
CONFIG = {
    ...
    ["SkyLight.CirrusCloudsIntensity"]       = { min = 0, max = 250000},
    ...
    ["Sun.SunIntensity"]                     = {min = 0, max = 120000, log = true},
    ["Sun.ScatteringIntensityScale"]         = { min = 0, max = 5, log = true },
